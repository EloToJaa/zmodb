...
pub const MODBUS_EXCEPTION_ILLEGAL_FUNCTION: c_int = 1;
pub const MODBUS_EXCEPTION_ILLEGAL_DATA_ADDRESS: c_int = 2;
pub const MODBUS_EXCEPTION_ILLEGAL_DATA_VALUE: c_int = 3;
pub const MODBUS_EXCEPTION_SLAVE_OR_SERVER_FAILURE: c_int = 4;
pub const MODBUS_EXCEPTION_ACKNOWLEDGE: c_int = 5;
pub const MODBUS_EXCEPTION_SLAVE_OR_SERVER_BUSY: c_int = 6;
pub const MODBUS_EXCEPTION_NEGATIVE_ACKNOWLEDGE: c_int = 7;
pub const MODBUS_EXCEPTION_MEMORY_PARITY: c_int = 8;
pub const MODBUS_EXCEPTION_NOT_DEFINED: c_int = 9;
pub const MODBUS_EXCEPTION_GATEWAY_PATH: c_int = 10;
pub const MODBUS_EXCEPTION_GATEWAY_TARGET: c_int = 11;
pub const MODBUS_EXCEPTION_MAX: c_int = 12;
const enum_unnamed_25 = c_uint;
pub extern const libmodbus_version_major: c_uint;
pub extern const libmodbus_version_minor: c_uint;
pub extern const libmodbus_version_micro: c_uint;
pub const struct__modbus = opaque {};
pub const modbus_t = struct__modbus;
pub const struct__modbus_mapping_t = extern struct {
    nb_bits: c_int = @import("std").mem.zeroes(c_int),
    start_bits: c_int = @import("std").mem.zeroes(c_int),
    nb_input_bits: c_int = @import("std").mem.zeroes(c_int),
    start_input_bits: c_int = @import("std").mem.zeroes(c_int),
    nb_input_registers: c_int = @import("std").mem.zeroes(c_int),
    start_input_registers: c_int = @import("std").mem.zeroes(c_int),
    nb_registers: c_int = @import("std").mem.zeroes(c_int),
    start_registers: c_int = @import("std").mem.zeroes(c_int),
    tab_bits: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    tab_input_bits: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    tab_input_registers: [*c]u16 = @import("std").mem.zeroes([*c]u16),
    tab_registers: [*c]u16 = @import("std").mem.zeroes([*c]u16),
};
pub const modbus_mapping_t = struct__modbus_mapping_t;
pub const MODBUS_ERROR_RECOVERY_NONE: c_int = 0;
pub const MODBUS_ERROR_RECOVERY_LINK: c_int = 2;
pub const MODBUS_ERROR_RECOVERY_PROTOCOL: c_int = 4;
pub const modbus_error_recovery_mode = c_uint;
pub const MODBUS_QUIRK_NONE: c_int = 0;
pub const MODBUS_QUIRK_MAX_SLAVE: c_int = 2;
pub const MODBUS_QUIRK_REPLY_TO_BROADCAST: c_int = 4;
pub const MODBUS_QUIRK_ALL: c_int = 255;
pub const modbus_quirks = c_uint;
pub extern fn modbus_set_slave(ctx: ?*modbus_t, slave: c_int) c_int;
pub extern fn modbus_get_slave(ctx: ?*modbus_t) c_int;
pub extern fn modbus_set_error_recovery(ctx: ?*modbus_t, error_recovery: modbus_error_recovery_mode) c_int;
pub extern fn modbus_set_socket(ctx: ?*modbus_t, s: c_int) c_int;
pub extern fn modbus_get_socket(ctx: ?*modbus_t) c_int;
pub extern fn modbus_get_response_timeout(ctx: ?*modbus_t, to_sec: [*c]u32, to_usec: [*c]u32) c_int;
pub extern fn modbus_set_response_timeout(ctx: ?*modbus_t, to_sec: u32, to_usec: u32) c_int;
pub extern fn modbus_get_byte_timeout(ctx: ?*modbus_t, to_sec: [*c]u32, to_usec: [*c]u32) c_int;
pub extern fn modbus_set_byte_timeout(ctx: ?*modbus_t, to_sec: u32, to_usec: u32) c_int;
pub extern fn modbus_get_indication_timeout(ctx: ?*modbus_t, to_sec: [*c]u32, to_usec: [*c]u32) c_int;
pub extern fn modbus_set_indication_timeout(ctx: ?*modbus_t, to_sec: u32, to_usec: u32) c_int;
pub extern fn modbus_get_header_length(ctx: ?*modbus_t) c_int;
pub extern fn modbus_connect(ctx: ?*modbus_t) c_int;
pub extern fn modbus_close(ctx: ?*modbus_t) void;
pub extern fn modbus_free(ctx: ?*modbus_t) void;
pub extern fn modbus_flush(ctx: ?*modbus_t) c_int;
pub extern fn modbus_set_debug(ctx: ?*modbus_t, flag: c_int) c_int;
pub extern fn modbus_strerror(errnum: c_int) [*c]const u8;
pub extern fn modbus_read_bits(ctx: ?*modbus_t, addr: c_int, nb: c_int, dest: [*c]u8) c_int;
pub extern fn modbus_read_input_bits(ctx: ?*modbus_t, addr: c_int, nb: c_int, dest: [*c]u8) c_int;
pub extern fn modbus_read_registers(ctx: ?*modbus_t, addr: c_int, nb: c_int, dest: [*c]u16) c_int;
pub extern fn modbus_read_input_registers(ctx: ?*modbus_t, addr: c_int, nb: c_int, dest: [*c]u16) c_int;
pub extern fn modbus_write_bit(ctx: ?*modbus_t, coil_addr: c_int, status: c_int) c_int;
pub extern fn modbus_write_register(ctx: ?*modbus_t, reg_addr: c_int, value: u16) c_int;
pub extern fn modbus_write_bits(ctx: ?*modbus_t, addr: c_int, nb: c_int, data: [*c]const u8) c_int;
pub extern fn modbus_write_registers(ctx: ?*modbus_t, addr: c_int, nb: c_int, data: [*c]const u16) c_int;
pub extern fn modbus_mask_write_register(ctx: ?*modbus_t, addr: c_int, and_mask: u16, or_mask: u16) c_int;
pub extern fn modbus_write_and_read_registers(ctx: ?*modbus_t, write_addr: c_int, write_nb: c_int, src: [*c]const u16, read_addr: c_int, read_nb: c_int, dest: [*c]u16) c_int;
pub extern fn modbus_report_slave_id(ctx: ?*modbus_t, max_dest: c_int, dest: [*c]u8) c_int;
pub extern fn modbus_mapping_new_start_address(start_bits: c_uint, nb_bits: c_uint, start_input_bits: c_uint, nb_input_bits: c_uint, start_registers: c_uint, nb_registers: c_uint, start_input_registers: c_uint, nb_input_registers: c_uint) [*c]modbus_mapping_t;
pub extern fn modbus_mapping_new(nb_bits: c_int, nb_input_bits: c_int, nb_registers: c_int, nb_input_registers: c_int) [*c]modbus_mapping_t;
pub extern fn modbus_mapping_free(mb_mapping: [*c]modbus_mapping_t) void;
pub extern fn modbus_send_raw_request(ctx: ?*modbus_t, raw_req: [*c]const u8, raw_req_length: c_int) c_int;
pub extern fn modbus_send_raw_request_tid(ctx: ?*modbus_t, raw_req: [*c]const u8, raw_req_length: c_int, tid: c_int) c_int;
pub extern fn modbus_receive(ctx: ?*modbus_t, req: [*c]u8) c_int;
pub extern fn modbus_receive_confirmation(ctx: ?*modbus_t, rsp: [*c]u8) c_int;
pub extern fn modbus_reply(ctx: ?*modbus_t, req: [*c]const u8, req_length: c_int, mb_mapping: [*c]modbus_mapping_t) c_int;
pub extern fn modbus_reply_exception(ctx: ?*modbus_t, req: [*c]const u8, exception_code: c_uint) c_int;
pub extern fn modbus_enable_quirks(ctx: ?*modbus_t, quirks_mask: c_uint) c_int;
pub extern fn modbus_disable_quirks(ctx: ?*modbus_t, quirks_mask: c_uint) c_int;
pub extern fn modbus_set_bits_from_byte(dest: [*c]u8, idx: c_int, value: u8) void;
pub extern fn modbus_set_bits_from_bytes(dest: [*c]u8, idx: c_int, nb_bits: c_uint, tab_byte: [*c]const u8) void;
pub extern fn modbus_get_byte_from_bits(src: [*c]const u8, idx: c_int, nb_bits: c_uint) u8;
pub extern fn modbus_get_float(src: [*c]const u16) f32;
pub extern fn modbus_get_float_abcd(src: [*c]const u16) f32;
pub extern fn modbus_get_float_dcba(src: [*c]const u16) f32;
pub extern fn modbus_get_float_badc(src: [*c]const u16) f32;
pub extern fn modbus_get_float_cdab(src: [*c]const u16) f32;
pub extern fn modbus_set_float(f: f32, dest: [*c]u16) void;
pub extern fn modbus_set_float_abcd(f: f32, dest: [*c]u16) void;
pub extern fn modbus_set_float_dcba(f: f32, dest: [*c]u16) void;
pub extern fn modbus_set_float_badc(f: f32, dest: [*c]u16) void;
pub extern fn modbus_set_float_cdab(f: f32, dest: [*c]u16) void;
pub extern fn modbus_new_rtu(device: [*c]const u8, baud: c_int, parity: u8, data_bit: c_int, stop_bit: c_int) ?*modbus_t;
pub extern fn modbus_rtu_set_serial_mode(ctx: ?*modbus_t, mode: c_int) c_int;
pub extern fn modbus_rtu_get_serial_mode(ctx: ?*modbus_t) c_int;
pub extern fn modbus_rtu_set_rts(ctx: ?*modbus_t, mode: c_int) c_int;
pub extern fn modbus_rtu_get_rts(ctx: ?*modbus_t) c_int;
pub extern fn modbus_rtu_set_custom_rts(ctx: ?*modbus_t, set_rts: ?*const fn (?*modbus_t, c_int) callconv(.C) void) c_int;
pub extern fn modbus_rtu_set_rts_delay(ctx: ?*modbus_t, us: c_int) c_int;
pub extern fn modbus_rtu_get_rts_delay(ctx: ?*modbus_t) c_int;
pub extern fn modbus_new_tcp(ip_address: [*c]const u8, port: c_int) ?*modbus_t;
pub extern fn modbus_tcp_listen(ctx: ?*modbus_t, nb_connection: c_int) c_int;
pub extern fn modbus_tcp_accept(ctx: ?*modbus_t, s: [*c]c_int) c_int;
pub extern fn modbus_new_tcp_pi(node: [*c]const u8, service: [*c]const u8) ?*modbus_t;
pub extern fn modbus_tcp_pi_listen(ctx: ?*modbus_t, nb_connection: c_int) c_int;
pub extern fn modbus_tcp_pi_accept(ctx: ?*modbus_t, s: [*c]c_int) c_int;
...
pub const MODBUS_VERSION_H = "";
pub const LIBMODBUS_VERSION_MAJOR = @as(c_int, 3);
pub const LIBMODBUS_VERSION_MINOR = @as(c_int, 1);
pub const LIBMODBUS_VERSION_MICRO = @as(c_int, 10);
pub const LIBMODBUS_VERSION = @compileError("invalid number suffix: '.10'");
// libmodbus/src/modbus-version.h:32:9
pub const LIBMODBUS_VERSION_STRING = "3.1.10";
pub const LIBMODBUS_VERSION_HEX = ((LIBMODBUS_VERSION_MAJOR << @as(c_int, 16)) | (LIBMODBUS_VERSION_MINOR << @as(c_int, 8))) | (LIBMODBUS_VERSION_MICRO << @as(c_int, 0));
pub inline fn LIBMODBUS_VERSION_CHECK(major: anytype, minor: anytype, micro: anytype) @TypeOf(((LIBMODBUS_VERSION_MAJOR > major) or ((LIBMODBUS_VERSION_MAJOR == major) and (LIBMODBUS_VERSION_MINOR > minor))) or (((LIBMODBUS_VERSION_MAJOR == major) and (LIBMODBUS_VERSION_MINOR == minor)) and (LIBMODBUS_VERSION_MICRO >= micro))) {
    _ = &major;
    _ = &minor;
    _ = &micro;
    return ((LIBMODBUS_VERSION_MAJOR > major) or ((LIBMODBUS_VERSION_MAJOR == major) and (LIBMODBUS_VERSION_MINOR > minor))) or (((LIBMODBUS_VERSION_MAJOR == major) and (LIBMODBUS_VERSION_MINOR == minor)) and (LIBMODBUS_VERSION_MICRO >= micro));
}
pub const MODBUS_API = "";
pub const MODBUS_BEGIN_DECLS = "";
pub const MODBUS_END_DECLS = "";
pub const FALSE = @as(c_int, 0);
pub const TRUE = @as(c_int, 1);
pub const OFF = @as(c_int, 0);
pub const ON = @as(c_int, 1);
pub const MODBUS_FC_READ_COILS = @as(c_int, 0x01);
pub const MODBUS_FC_READ_DISCRETE_INPUTS = @as(c_int, 0x02);
pub const MODBUS_FC_READ_HOLDING_REGISTERS = @as(c_int, 0x03);
pub const MODBUS_FC_READ_INPUT_REGISTERS = @as(c_int, 0x04);
pub const MODBUS_FC_WRITE_SINGLE_COIL = @as(c_int, 0x05);
pub const MODBUS_FC_WRITE_SINGLE_REGISTER = @as(c_int, 0x06);
pub const MODBUS_FC_READ_EXCEPTION_STATUS = @as(c_int, 0x07);
pub const MODBUS_FC_WRITE_MULTIPLE_COILS = @as(c_int, 0x0F);
pub const MODBUS_FC_WRITE_MULTIPLE_REGISTERS = @as(c_int, 0x10);
pub const MODBUS_FC_REPORT_SLAVE_ID = @as(c_int, 0x11);
pub const MODBUS_FC_MASK_WRITE_REGISTER = @as(c_int, 0x16);
pub const MODBUS_FC_WRITE_AND_READ_REGISTERS = @as(c_int, 0x17);
pub const MODBUS_BROADCAST_ADDRESS = @as(c_int, 0);
pub const MODBUS_MAX_READ_BITS = @as(c_int, 2000);
pub const MODBUS_MAX_WRITE_BITS = @as(c_int, 1968);
pub const MODBUS_MAX_READ_REGISTERS = @as(c_int, 125);
pub const MODBUS_MAX_WRITE_REGISTERS = @as(c_int, 123);
pub const MODBUS_MAX_WR_WRITE_REGISTERS = @as(c_int, 121);
pub const MODBUS_MAX_WR_READ_REGISTERS = @as(c_int, 125);
pub const MODBUS_MAX_PDU_LENGTH = @as(c_int, 253);
pub const MODBUS_MAX_ADU_LENGTH = @as(c_int, 260);
pub const MODBUS_ENOBASE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 112345678, .decimal);
pub const EMBXILFUN = MODBUS_ENOBASE + MODBUS_EXCEPTION_ILLEGAL_FUNCTION;
pub const EMBXILADD = MODBUS_ENOBASE + MODBUS_EXCEPTION_ILLEGAL_DATA_ADDRESS;
pub const EMBXILVAL = MODBUS_ENOBASE + MODBUS_EXCEPTION_ILLEGAL_DATA_VALUE;
pub const EMBXSFAIL = MODBUS_ENOBASE + MODBUS_EXCEPTION_SLAVE_OR_SERVER_FAILURE;
pub const EMBXACK = MODBUS_ENOBASE + MODBUS_EXCEPTION_ACKNOWLEDGE;
pub const EMBXSBUSY = MODBUS_ENOBASE + MODBUS_EXCEPTION_SLAVE_OR_SERVER_BUSY;
pub const EMBXNACK = MODBUS_ENOBASE + MODBUS_EXCEPTION_NEGATIVE_ACKNOWLEDGE;
pub const EMBXMEMPAR = MODBUS_ENOBASE + MODBUS_EXCEPTION_MEMORY_PARITY;
pub const EMBXGPATH = MODBUS_ENOBASE + MODBUS_EXCEPTION_GATEWAY_PATH;
pub const EMBXGTAR = MODBUS_ENOBASE + MODBUS_EXCEPTION_GATEWAY_TARGET;
pub const EMBBADCRC = EMBXGTAR + @as(c_int, 1);
pub const EMBBADDATA = EMBXGTAR + @as(c_int, 2);
pub const EMBBADEXC = EMBXGTAR + @as(c_int, 3);
pub const EMBUNKEXC = EMBXGTAR + @as(c_int, 4);
pub const EMBMDATA = EMBXGTAR + @as(c_int, 5);
pub const EMBBADSLAVE = EMBXGTAR + @as(c_int, 6);
pub inline fn MODBUS_GET_HIGH_BYTE(data: anytype) @TypeOf((data >> @as(c_int, 8)) & @as(c_int, 0xFF)) {
    _ = &data;
    return (data >> @as(c_int, 8)) & @as(c_int, 0xFF);
}
pub inline fn MODBUS_GET_LOW_BYTE(data: anytype) @TypeOf(data & @as(c_int, 0xFF)) {
    _ = &data;
    return data & @as(c_int, 0xFF);
}
pub inline fn MODBUS_GET_INT64_FROM_INT16(tab_int16: anytype, index: anytype) @TypeOf((((@import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index))]) << @as(c_int, 48)) | (@import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index + @as(c_int, 1)))]) << @as(c_int, 32))) | (@import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index + @as(c_int, 2)))]) << @as(c_int, 16))) | @import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index + @as(c_int, 3)))])) {
    _ = &tab_int16;
    _ = &index;
    return (((@import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index))]) << @as(c_int, 48)) | (@import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index + @as(c_int, 1)))]) << @as(c_int, 32))) | (@import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index + @as(c_int, 2)))]) << @as(c_int, 16))) | @import("std").zig.c_translation.cast(i64, tab_int16[@as(usize, @intCast(index + @as(c_int, 3)))]);
}
pub inline fn MODBUS_GET_INT32_FROM_INT16(tab_int16: anytype, index: anytype) @TypeOf((@import("std").zig.c_translation.cast(i32, tab_int16[@as(usize, @intCast(index))]) << @as(c_int, 16)) | @import("std").zig.c_translation.cast(i32, tab_int16[@as(usize, @intCast(index + @as(c_int, 1)))])) {
    _ = &tab_int16;
    _ = &index;
    return (@import("std").zig.c_translation.cast(i32, tab_int16[@as(usize, @intCast(index))]) << @as(c_int, 16)) | @import("std").zig.c_translation.cast(i32, tab_int16[@as(usize, @intCast(index + @as(c_int, 1)))]);
}
pub inline fn MODBUS_GET_INT16_FROM_INT8(tab_int8: anytype, index: anytype) @TypeOf((@import("std").zig.c_translation.cast(i16, tab_int8[@as(usize, @intCast(index))]) << @as(c_int, 8)) | @import("std").zig.c_translation.cast(i16, tab_int8[@as(usize, @intCast(index + @as(c_int, 1)))])) {
    _ = &tab_int8;
    _ = &index;
    return (@import("std").zig.c_translation.cast(i16, tab_int8[@as(usize, @intCast(index))]) << @as(c_int, 8)) | @import("std").zig.c_translation.cast(i16, tab_int8[@as(usize, @intCast(index + @as(c_int, 1)))]);
}
pub const MODBUS_SET_INT16_TO_INT8 = @compileError("unable to translate C expr: unexpected token 'do'");
// libmodbus/src/modbus.h:291:9
pub const MODBUS_SET_INT32_TO_INT16 = @compileError("unable to translate C expr: unexpected token 'do'");
// libmodbus/src/modbus.h:296:9
pub const MODBUS_SET_INT64_TO_INT16 = @compileError("unable to translate C expr: unexpected token 'do'");
// libmodbus/src/modbus.h:301:9
pub const MODBUS_RTU_H = "";
pub const MODBUS_RTU_MAX_ADU_LENGTH = @as(c_int, 256);
pub const MODBUS_RTU_RS232 = @as(c_int, 0);
pub const MODBUS_RTU_RS485 = @as(c_int, 1);
pub const MODBUS_RTU_RTS_NONE = @as(c_int, 0);
pub const MODBUS_RTU_RTS_UP = @as(c_int, 1);
pub const MODBUS_RTU_RTS_DOWN = @as(c_int, 2);
pub const MODBUS_TCP_H = "";
pub const MODBUS_TCP_DEFAULT_PORT = @as(c_int, 502);
pub const MODBUS_TCP_SLAVE = @as(c_int, 0xFF);
pub const MODBUS_TCP_MAX_ADU_LENGTH = @as(c_int, 260);
...
pub const _modbus = struct__modbus;
pub const _modbus_mapping_t = struct__modbus_mapping_t;
